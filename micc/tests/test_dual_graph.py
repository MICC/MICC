...
class DualGraphTests(unittest.TestCase):
    ...
    def test_dual_graph_repeat_is_2(self):
        true_dual_graph = {0+0j: [5+0j, 5+1j, 4+0j, 4+1j, 3+0j],
                           0+1j: [5+0j, 5+1j, 4+0j, 4+1j, 3+1j],
                           1+0j: [2+0j, 2+1j, 3+0j, 3+1j, 4+0j],
                           1+1j: [2+0j, 2+1j, 3+0j, 3+1j, 4+1j],
                           2+0j: [1+0j, 1+1j, 3+0j, 3+1j, 2+0j, 2+1j],
                           2+1j: [1+0j, 1+1j, 3+0j, 3+1j, 2+0j, 2+1j],
                           3+0j: [0+0j, 1+0j, 1+1j, 2+0j, 2+1j],
                           3+1j: [0+1j, 1+0j, 1+1j, 2+0j, 2+1j],
                           4+0j: [0+0j, 0+1j, 1+0j, 5+0j, 5+1j],
                           4+1j: [0+0j, 0+1j, 1+1j, 5+0j, 5+1j],
