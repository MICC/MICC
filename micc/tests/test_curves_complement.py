...
class DistanceTests(unittest.TestCase):
    ...
    def test_7(self):
        # loops:
        old_loops = [(0, 11, 17, 14, 20, 10, 18, 15, 16, 13), (0, 11, 17, 14, 20, 10, 18, 15, 12, 1, 3, 5, 7, 9, 19, 16, 13), (2, 4, 6, 8, 20, 14, 17, 11), (1, 12, 19, 9, 7, 5, 3), (0, 2, 4, 6, 8, 10, 18, 15, 19, 9, 7, 5, 3, 1, 12, 16, 13), (0, 11, 17, 14, 20, 10, 18, 15, 19, 9, 7, 5, 3, 1, 12, 16, 13), (0, 2, 4, 6, 8, 10, 18, 15, 16, 13), (0, 13, 16, 19, 9, 7, 5, 3, 1, 12, 15, 18, 10, 8, 6, 4, 2)]
        test = CurvePair([[19, 18, 1, 2, 3, 4, 5, 6, 7, 8, 9, 18, 19, 20, 21, 14, 15, 16, 17, 21, 20],
                         ...
                         compute=True)
        stderr.write('old loops:\n')
        for loop in old_loops:
            stderr.write(str(loop)+'\n')
        stderr.write('new loops:\n')
        for loop in test.complementary_curves:
            stderr.write(str(loop.arc_path)+'\n')
        self.assertEqual(test.distance, 'at least 4')
